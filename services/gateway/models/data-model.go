...
type DataModel struct {
	...
	RatingAndComments *protobuf.DataModel_RatingAndComments `json:"ratingAndComments,omitempty"`
	Statistics        *protobuf.DataModelStatistics         `json:"statistics,omitempty"`
...
func (dc *DataModel) Convert(input *protobuf.DataModel) {
	dc.Id = input.Id
	dc.Name = input.Name
...
func (dc *DataModel) ConvertDataStructure(input []*protobuf.DataStructure) {
