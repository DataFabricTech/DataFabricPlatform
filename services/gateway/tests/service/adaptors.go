					...
					ConnSchema: []*protobuf.InputField{
						{
							Key:         "HOST",
							Required:    true,
							ValueType:   protobuf.DataType_STRING,
						...
						},
						{
							Key:         "PORT",
							Required:    true,
							ValueType:   protobuf.DataType_INT32,
							Default:     "Port Number",
					...
					BasicOptions: []*protobuf.InputField{
						{
							Key:         "HOST",
							Required:    true,
							ValueType:   protobuf.DataType_DOUBLE,
							Default:     "IP address or Domain",
							Description: "Data Storage IP Address or Domain",
						},
						{
							Key:         "PORT",
							Required:    true,
							ValueType:   protobuf.DataType_FLOAT,
							Default:     "Port Number",
							Description: "Data Storage Port Number",
						},
						{
							Key:         "DATABASE",
							Required:    true,
							ValueType:   protobuf.DataType_DATETIME,
							Default:     "DatabaseName",
							Description: "Database Name of Data Storage",
						},
						{
							Key:         "SCOPE",
							Required:    true,
							ValueType:   protobuf.DataType_INT64,
							Default:     "scope",
					...
					AdditionalOptions: []*protobuf.InputField{
						{
							Key:         "addOptions02",
							Required:    true,
							ValueType:   protobuf.DataType_BYTES,
							Default:     "add-option-sample-02",
							Description: "Option Sample Desc 02",
						},
						{
							Key:         "addOptions03",
							Required:    true,
							ValueType:   protobuf.DataType_BOOL,
							Default:     "add-option-sample-03",
							Description: "Option Sample Desc 03",
						},
					},
