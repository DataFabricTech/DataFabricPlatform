...
//@Slf4j
//public class PortalService implements PortalCallBack {
//    private final SearchRepository searchRepository;
////    private final DBConfig dbConfig;
//    private final SearchConfig searchConfig;
//
//    public PortalService(SearchRepository searchRepository, DBConfig dbConfig, SearchConfig searchConfig) {
...
//                                            totalSize / searchConfig.getDefaultSearchSize() + totalSize % searchConfig.getDefaultSearchSize() != 0 ? 1 : 0 :
...
//        var userId = "testUser"; // todo request.getUserId
//        try {
//            var recentSearches = searchRepository.recentSearches(userId);
...
//        var searchModel = searchRepository.search(
...
//        var searchModel = searchRepository.search(storageMainQueryBuilder(input), pageable);
//
//        var totalSize = searchModel.getTotalSize();
//
...
//        var facet = searchRepository.getFacet(
//                mainQueryBuilder(input),
//                details.isEmpty() ? null : mustQueryBuilder(details),
//                filters.isEmpty() ? null : shouldQueryBuilder(filters));
//
...
//
//            searchRepository.insertDocument(recentSearchModel);
//        } else {
...
//
//            if (arr.size() < searchConfig.getNumberOfSaveRecentSearches()) {
//                arr.addLast(input);
//            } else {
//                arr.pollFirst();
//                arr.addFirst(input);
...
//            recentSearchModel.setRecentSearches(arr.toArray(new String[0]));
//
//            searchRepository.updateDocument(recentSearchModel, docId);
//        }
//
//    }
//
...
////                    }
////
////                    searchRepository.insertDocument(dataModel);
...
////                    }
////                    searchRepository.insertDocument(storageModel);
////                }
...
////                    var dataModel = searchRepository.getDataModelDocument(id);
////
////                    for (var sql : sqls) {
...
////                    }
////
////                    searchRepository.updateDocument(dataModel, id);
////                } else if (storageTableNames.contains(tableName)) {
////                    var id = getId(updateState);
////                    var storageModel = searchRepository.getStorageDocuemnt(id);
////
////                    for (var sql : sqls) {
////                        updateState = (Update) CCJSqlParserUtil.parse(sql);
...
////                    }
////
////                    searchRepository.updateDocument(storageModel, id);
////                }
////            } else if (state instanceof Delete deleteState) {
////                var tableName = deleteState.getTable().getName().toLowerCase();
////                if (dataModelTableNames.contains(tableName)) {
////                    searchRepository.deleteDataModelDocument(getId(deleteState));
////                } else if (storageTableNames.contains(tableName)) {
////                    searchRepository.deleteStorageDocument(getId(deleteState));
////                }
////            }
...
//        return searchRepository.searchStorageAll();
//    }
//
//    public List<String> searchAllDataModel() throws IOException, OpenSearchException {
//        return searchRepository.searchDataModelAll();
//    }
//
...
//        var dataModel = searchRepository.getDataModelDocument(getId(update));
//
//        for (var set : update.getUpdateSets()) {
//            var columns = set.getColumns();
//            var values = set.getValues();
...
//            OpenSearchException, IOException, IndexOutOfBoundsException {
//        var storageModel = searchRepository.getStorageDocuemnt(getId(update));
//
//        for (var set : update.getUpdateSets()) {
//            var columns = set.getColumns();
//            var values = set.getValues();
...
//        try {
//            searchRepository.deleteSearchesDocument(id);
//        } catch (OpenSearchException | IOException e) {
//            throw e;
//        }
//    }
...
//        var fields = searchConfig.getFilters();
