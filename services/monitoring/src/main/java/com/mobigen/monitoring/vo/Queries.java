...
public enum Queries {
    ...
    ORACLE_GET_DATABASES("sql/get-database-from-oracle.sql"),
    GET_TABLES("sql/get-tables.sql"),
    GET_TABLES_FROM_ORACLE("sql/get-all-tables-from-oracle.sql"),
    POSTGRES_GET_DATABASES("sql/get-database-from-postgres.sql"),
    GET_ALL_TABLE_ROWS("sql/get-all-table-rows.sql"),
    GET_ALL_TABLE_ROWS_FROM_ORACLE("sql/get-all-table-rows-from-oracle.sql"),
